# ABOUTME: Tests for trajectory text formatting consumed by TrajectoryEncoder — mock backbone, no real LLM loaded.
# ABOUTME: Run: pytest tests/test_trajectory_encoder.py
