# ABOUTME: Unit tests for src/data_collection — keep rules, temperature schedule, episode
...
def _run(cfg, monkeypatch):
    monkeypatch.setattr("src.data_collection.collection_runner.get_adapter",
                        lambda bcfg: FakeAdapter(bcfg))
    monkeypatch.setattr("src.data_collection.collection_runner._build_client",
