# ABOUTME: Unit tests for src/lagrangian_finetuning/dual_variable.py — λ update direction, clamping, state_dict.
# ABOUTME: Run: pytest tests/test_lagrangian_finetuning.py
"""
