#!/bin/bash
# ============================================================================
# run_experiment.sh — full ICRL pipeline in one job
# ============================================================================
#
...
#   PROFILE=smoke sbatch --gres=gpu:h100:1 --time=00:30:00 slurm/run_experiment.sh
#
#   # Only part of the pipeline:
#   STAGES=constraint,gate sbatch slurm/run_experiment.sh
#
#   # Extra Hydra overrides:
#   EXTRA="--override finetune.ppo.steps=50" sbatch slurm/run_experiment.sh
#
