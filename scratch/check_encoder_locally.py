#!/usr/bin/env python3
# ABOUTME: Manual sanity check that TrajectoryEncoder loads Qwen2.5-1.5B on MPS/CPU and scores real demo JSONL data.
# ABOUTME: Run: python scratch/check_encoder_locally.py [--max-length 256] (needs data/demos/{safe,unsafe}.jsonl)
"""
