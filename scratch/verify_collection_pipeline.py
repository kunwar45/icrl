...
Usage:
    cd /path/to/icrl
    python scratch/verify_collection_pipeline.py
...
# activate_icrl.sh / scripts/slurm/env.sh) instead of hardcoding one developer's laptop.
...
def test_syntax():
    ...
    import ast
    files = [
        "scripts/demos/collect_safe_trajectories.py",
...
def test_pw_extra_args_in_collect():
    ...
    src = open("scripts/demos/collect_safe_trajectories.py").read()
