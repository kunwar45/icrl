#!/usr/bin/env python3
# ABOUTME: Builds the chain-of-thought deception dataset: honest vs deceptive Qwen-72B reasoning traces
# ABOUTME: Run: python scripts/build_chain_of_thought_dataset.py +compute=local run_name=cot_data_v1 ...
"""
...
Usage:
    python scripts/build_chain_of_thought_dataset.py +compute=local run_name=cot_data_v1 \
...
from src.trajectory_data.reasoning_trace import ReasoningStep, ReasoningTrace, CausalScorer, save_traces
