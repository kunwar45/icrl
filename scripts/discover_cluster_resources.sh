#!/bin/bash
# ABOUTME: Read-only probe of a SLURM cluster: accounts, GPU types, partitions, modules, filesystems
# ABOUTME: Run on a login node: bash scripts/discover_cluster_resources.sh [--save]; feed results into ICRL_* vars
# ============================================================================
# discover_cluster_resources.sh — report what THIS cluster actually offers
# ============================================================================
#
...
#   bash scripts/discover_cluster_resources.sh --save     # also write cluster_probe.txt
#
# Feed the results into scripts/submit_experiment.sh via ICRL_ACCOUNT /
