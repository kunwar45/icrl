#!/usr/bin/env python3
# ABOUTME: Pre-computes trajectory embeddings with a frozen Qwen backbone and saves .pt bundles for ICRL training
# ABOUTME: Run: python scripts/embed_trajectories.py --input-dir <traj_dir> --label safe --output embeddings/safe.pt
"""
