...
Usage:
    python scripts/make_plots.py --run-name icrl_cluster
    python scripts/make_plots.py --run-name icrl_cluster --theme dark --pdf
"""
...
<body><main>
  ...
  <div class="sub">ICRL safety experiment · generated by scripts/make_plots.py</div>
