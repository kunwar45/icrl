...
Usage:
    python scripts/cot/cot_finetune.py +compute=local +cot=finetune \
...
For multi-seed / multi-epsilon sweeps, use sweep_finetune_hyperparams.py:
    python scripts/sweep_finetune_hyperparams.py --mode local --script scripts/cot/cot_finetune.py
"""
import torch
import hydra
