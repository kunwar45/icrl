...
The constraint gate check (scripts/constraint/eval_constraint.py) must run on trajectories
...
Usage:
    python scripts/demos/make_train_eval_splits.py                      # defaults below
    python scripts/demos/make_train_eval_splits.py --held-out-frac 0.3 --seed 7
...
Inputs — either format, per side:
    ...
    python scripts/demos/make_train_eval_splits.py --safe $SCRATCH/trajectories/safe
...
from src.data.trace_loader import load_demos  # noqa: E402
