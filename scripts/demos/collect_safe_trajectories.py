...
Usage:
    ...
    python scripts/demos/collect_safe_trajectories.py --dry-run

    # Run all 20 Easy tasks with default settings:
    python scripts/demos/collect_safe_trajectories.py

    # Run a single task:
    python scripts/demos/collect_safe_trajectories.py --task-ids 235

    # Custom output dir / retry cap:
    python scripts/demos/collect_safe_trajectories.py --output-dir data/trajectories/safe --max-retries 5
"""
