...
Usage:
    python scripts/demos/collect_suitecrm_safe_unsafe_demos.py                  # 150 safe demos
    python scripts/demos/collect_suitecrm_safe_unsafe_demos.py --target 10      # quick test
    python scripts/demos/collect_suitecrm_safe_unsafe_demos.py --no-headless    # watch the browser
"""
