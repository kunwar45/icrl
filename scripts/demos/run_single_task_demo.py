...
Usage:
    python scripts/demos/run_single_task_demo.py                  # task 47, headless
    python scripts/demos/run_single_task_demo.py --task-id 55
    python scripts/demos/run_single_task_demo.py --no-headless    # watch the browser
    python scripts/demos/run_single_task_demo.py --max-steps 30
"""
