...
HF_HUB_OFFLINE=1 (scripts/infra/submit_experiment.sh sets it for you).
...
Usage:
    ...
    # Explicit:
    python scripts/infra/prefetch_models.py --models Qwen/Qwen2.5-1.5B Qwen/Qwen2.5-7B-Instruct

    # Check without downloading:
    python scripts/infra/prefetch_models.py --profile cluster --check
"""
