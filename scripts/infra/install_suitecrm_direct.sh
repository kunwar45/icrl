...
#
# Usage:
#   bash scripts/infra/install_suitecrm_direct.sh             # full install + start
#   bash scripts/infra/install_suitecrm_direct.sh --restart   # skip install, just restart Apache
#
# Prerequisites:
