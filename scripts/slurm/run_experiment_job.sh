...
#
# Demos must already exist (scripts/slurm/collect_safe_trajectories_job.sh, scripts/slurm/collect_unsafe_demos_job.sh).
...
#
# NOTE: submit with scripts/infra/submit_experiment.sh, which supplies --account,
