#!/bin/bash
# ABOUTME: SLURM array wrapper for scripts/finetune_policy.py — 9-task epsilon x seed sweep, one combo per array task
# ABOUTME: Submit: sbatch scripts/slurm/finetune_policy_array_job.sh (SLURM_ARRAY_TASK_ID picks epsilon and seed)
