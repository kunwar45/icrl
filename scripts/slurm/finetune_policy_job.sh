#!/bin/bash
# ABOUTME: SLURM wrapper for scripts/finetune_policy.py — Lagrangian constrained fine-tuning on GPUs
# ABOUTME: Submit: sbatch scripts/slurm/finetune_policy_job.sh [hydra overrides forwarded via "$@"]
