...
Usage:
    python scripts/gridworld/run_stwebagent_icrl_loop.py
    python scripts/gridworld/run_stwebagent_icrl_loop.py --config configs/experiment/stwebagent.yaml

Prerequisites:
    export TOGETHER_API_KEY=your-key-here
    pip install -e ".[stwebagent]"
    playwright install chromium
    python scripts/gridworld/generate_safe_demos_llm_policy.py --task-ids 235 --output data/stwebagent_safe_demos.jsonl
