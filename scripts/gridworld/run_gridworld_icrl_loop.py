...
Usage:
    python scripts/gridworld/run_gridworld_icrl_loop.py
    python scripts/gridworld/run_gridworld_icrl_loop.py --config configs/experiment/gridworld_smoke.yaml
    python scripts/gridworld/run_gridworld_icrl_loop.py --no-constraint   # plain PPO baseline
"""
