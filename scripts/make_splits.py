...
The constraint gate check (scripts/eval_constraint.py) must run on trajectories
...
Usage:
    python scripts/make_splits.py                      # defaults below
    python scripts/make_splits.py --held-out-frac 0.3 --seed 7
...
Inputs — either format, per side:
    ...
    python scripts/make_splits.py --safe $SCRATCH/trajectories/safe
