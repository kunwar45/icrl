# ABOUTME: Shared matplotlib chart style: light/dark themes, validated 3-colour palette and thin mark specs.
# ABOUTME: Imported by scripts/make_experiment_plots.py so every experiment figure looks the same.
"""
