# ABOUTME: ICRL constraint trainer: alternates policy-rollout collection with constraint_update gradient steps.
# ABOUTME: Pushes policy scores high while anchoring expert scores below beta; run via scripts/train_constraint.py.
"""
