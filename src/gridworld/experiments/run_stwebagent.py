# ABOUTME: Entrypoint running adversarial ICRL on ST-WebAgentBench with a Together AI LLM (Qwen) policy.
# ABOUTME: Run: python experiments/run_stwebagent.py --config <yaml>; needs TOGETHER_API_KEY + demos JSONL.
"""
