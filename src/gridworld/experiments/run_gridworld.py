# ABOUTME: Entrypoint running adversarial ICRL on the 4x4 GridWorld to recover the hidden col-0 constraint.
# ABOUTME: Run: python experiments/run_gridworld.py [--config <yaml>] [--no-constraint] for PPO baseline.
"""
...
from icrl.embedders.mean_pool_embedder import MeanPoolEmbedderConfig, MeanPoolEmbedder
...
from icrl.utils.visualization import _make_canonical_trajectories, print_training_report
