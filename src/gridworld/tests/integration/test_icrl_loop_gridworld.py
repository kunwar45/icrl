# ABOUTME: Integration tests of the adversarial ICRL loop on the 4x4 GridWorld (detector to trainer).
# ABOUTME: Run with: pytest src/gridworld/tests/integration/test_icrl_loop_gridworld.py
"""
...
from icrl.embedders.mean_pool_embedder import MeanPoolEmbedder, MeanPoolEmbedderConfig
...
from icrl.policies.rule_based_policy import SafeRuleBasedPolicy, UnsafeRuleBasedPolicy
