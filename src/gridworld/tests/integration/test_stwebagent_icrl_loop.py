# ABOUTME: Integration test of the full ST-WebAgentBench ICRL loop with BrowserGym and Together AI mocked.
# ABOUTME: Runs offline: pytest src/gridworld/tests/integration/test_stwebagent_icrl_loop.py
...
def test_stwebagent_icrl_loop_runs_3_iterations():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with (
            ...
            patch("icrl.embedders.sentence_transformer_embedder._ST") as MockST,
        ):
            ...
            from icrl.embedders.sentence_transformer_embedder import (
