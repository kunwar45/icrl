# ABOUTME: Unit tests for SentenceTransformerEmbedder with the pretrained model mocked.
# ABOUTME: Run with: pytest src/gridworld/tests/unit/test_sentence_transformer.py
...
def test_embed_trajectory_returns_1d_tensor():
    with patch("icrl.embedders.sentence_transformer_embedder._ST") as MockST:
