# ABOUTME: Unit tests for STWebAgentEnv with BrowserGym mocked (reward shaping, obs stripping, termination).
# ABOUTME: Run with: pytest src/gridworld/tests/unit/test_stwebagent_env.py
