# ABOUTME: Unit tests for constraint losses: contrastive separation, gradient flow, margin, and InfoNCE.
# ABOUTME: Run with: pytest src/gridworld/tests/unit/test_constraint_loss.py
"""Unit tests for constraint loss functions."""
import torch
import pytest
from icrl.constraints.constraint_losses import contrastive_loss, margin_loss, info_nce_loss
