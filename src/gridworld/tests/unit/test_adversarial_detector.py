# ABOUTME: Unit tests for AdversarialDetector threshold modes (max, mean+std, percentile) and unsafe flagging.
# ABOUTME: Run with: pytest src/gridworld/tests/unit/test_adversarial_detector.py
