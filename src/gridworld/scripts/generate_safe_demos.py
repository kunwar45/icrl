# ABOUTME: Generates safe ST-WebAgentBench demonstrations by rolling out the safety-prompted LLM policy.
# ABOUTME: Run: python scripts/generate_safe_demos.py --task-ids 235 --output <jsonl>; needs TOGETHER_API_KEY.
