# ABOUTME: MLP constraint C_theta: trajectory embedding + reward/length features -> feasibility in [0,1].
# ABOUTME: Trained contrastively on safe demos vs flagged unsafe rollouts; cost=-log(C) feeds PPO-Lag.
"""
...
from icrl.constraints.constraint_losses import contrastive_loss, margin_loss
