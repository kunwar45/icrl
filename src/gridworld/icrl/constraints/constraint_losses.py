# ABOUTME: Losses for the contrastive constraint update: contrastive (BCE), pairwise margin, and InfoNCE.
# ABOUTME: Imported by MLPConstraint.update() to score safe (target 1) vs unsafe (target 0) feasibilities.
"""
