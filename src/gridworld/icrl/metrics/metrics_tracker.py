# ABOUTME: MetricsTracker writing per-iteration training metrics to metrics.jsonl and optional TensorBoard.
# ABOUTME: Instantiated by ICRLTrainer with the run's log_dir; log(metrics, step) appends one JSON line.
