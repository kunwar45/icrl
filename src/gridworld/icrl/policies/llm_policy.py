# ABOUTME: LLM web-agent policy calling Together AI (Qwen) to emit one BrowserGym action per turn.
# ABOUTME: No gradient updates; the constraint shapes the prompt via a cost-threshold warning.
