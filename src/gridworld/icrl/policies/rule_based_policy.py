# ABOUTME: Deterministic GridWorld oracle policies: safe col-1 detour and unsafe col-0 shortcut.
# ABOUTME: Used in tests to validate the adversarial detector and constraint recovery.
"""
