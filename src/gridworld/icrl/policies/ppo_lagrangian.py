# ABOUTME: PPO-Lagrangian policy: PPO with a learned multiplier penalising constraint cost above cost_limit.
# ABOUTME: Consumes episode-level cost -log C_theta(tau) from the constraint; used for GridWorld training.
"""
