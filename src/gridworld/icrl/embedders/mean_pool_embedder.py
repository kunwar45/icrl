# ABOUTME: Trajectory embedder that tokenises obs/action text and mean-pools a learned embedding table.
# ABOUTME: Trains jointly with the constraint MLP; used for gridworld runs needing no pretrained model.
"""
