# ABOUTME: Trajectory embedder using a frozen SentenceTransformer over the full episode as one string.
# ABOUTME: Used for ST-WebAgentBench runs; sentence-transformers is imported lazily so tests can mock it.
