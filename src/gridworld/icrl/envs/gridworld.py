# ABOUTME: 4x4 GridWorld env with hidden constraint: cells (1,0)/(2,0) unsafe; safe path detours via col 1.
# ABOUTME: The unsafe col-0 shortcut earns reward 17 vs safe 15 -- the gap the adversarial detector exploits.
"""
