# ABOUTME: BaseEnv wrapper around a BrowserGym ST-WebAgentBench task with shaped step/completion reward.
# ABOUTME: Used by run_stwebagent.py and generate_safe_demos.py; strips screenshot bytes from observations.
