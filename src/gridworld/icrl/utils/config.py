# ABOUTME: load_config(): YAML experiment-config loader returning a plain dict, with deep-merge overrides.
# ABOUTME: Used by the experiment entrypoints to read configs/experiment/*.yaml.
