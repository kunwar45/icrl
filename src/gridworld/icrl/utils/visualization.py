# ABOUTME: ANSI-terminal report for GridWorld ICRL: grid render, feasibility probes, metrics, recent episodes.
# ABOUTME: print_training_report() is called at each eval step by run_gridworld's _VisualizingTrainer.
