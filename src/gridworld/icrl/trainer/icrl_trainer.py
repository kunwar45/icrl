# ABOUTME: ICRLTrainer main loop: collect rollouts, flag unsafe by reward, update constraint, update policy.
# ABOUTME: Driven by experiments/run_gridworld.py and run_stwebagent.py; logs via MetricsTracker.
"""
...
from icrl.metrics.metrics_tracker import MetricsTracker
