# ABOUTME: AdversarialDetector: labels rollouts unsafe when their reward exceeds the safe-demo threshold.
# ABOUTME: fit() derives the threshold from safe demos (max/mean+std/percentile); queried each iteration.
"""
