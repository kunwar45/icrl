# ABOUTME: collect_rollouts(): runs a policy in an env for n steps, packaging episodes as Trajectories.
# ABOUTME: Called by ICRLTrainer each iteration and by scripts/generate_safe_demos.py.
