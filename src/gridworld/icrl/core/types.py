# ABOUTME: Core dataclasses: Transition, Trajectory, and DemoDataset with the safe-reward threshold property.
# ABOUTME: Imported by all ICRL components as icrl.core.types; no logic beyond aggregation helpers.
