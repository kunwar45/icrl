# ABOUTME: Abstract base classes (BaseEnv, BaseEmbedder, BaseConstraint, BasePolicy) defining ICRL contracts.
# ABOUTME: Every env, embedder, constraint, and policy subclasses these so components stay swappable.
