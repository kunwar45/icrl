# ABOUTME: Generates safe GridWorld demonstrations that detour via col 1 (5 steps, reward 15).
# ABOUTME: GridWorldDemoLoader.load() replays the canonical safe action sequence into a DemoDataset.
...
from icrl.demos.demo_loader import BaseDemoLoader
