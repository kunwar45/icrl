# ABOUTME: Lagrangian constrained fine-tuning loop: REINFORCE-with-baseline on R(tau) - lambda*C_theta(tau).
# ABOUTME: The core of the fine-tuning stage; driven by scripts/finetune_policy.py.
"""
...
Convention (same as src/icrl_dual_training/constraint_trainer.py): HIGH C_theta = high cost =
...
from src.lagrangian_finetuning.dual_variable import DualVariable
from src.lagrangian_finetuning.reward_model import RewardModel
from src.lagrangian_finetuning.policy_rollout import (
    PolicyActor,
    RolloutResult,
    StepRecord,
    TaskEnvironment,
...
class LagrangianPPOTrainer:
    ...
    def __init__(
        ...
        # Suffixed — see the matching note in src/icrl_dual_training/constraint_trainer.py.
