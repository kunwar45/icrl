# ABOUTME: Dual variable lambda for the Lagrangian objective, updated by ascent on E[C_theta] - epsilon.
# ABOUTME: Used by lagrangian_ppo_trainer.py to weight the constraint penalty during policy fine-tuning.
"""
