# ABOUTME: Task-completion reward R(tau): benchmark reward plus step/truncation penalties, plus the CuP check.
# ABOUTME: Used by policy_rollout and lagrangian_ppo_trainer; deliberately separate from the constraint C_theta.
"""
