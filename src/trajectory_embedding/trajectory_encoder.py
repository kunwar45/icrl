# ABOUTME: TrajectoryEncoder: frozen Qwen backbone + trainable MLP head mapping trajectory text to C_theta(tau).
# ABOUTME: Built via load_qwen_encoder(); used by scripts/embed_trajectories.py, constraint training and finetuning.
"""
