# ABOUTME: LoRA-aware HuggingFace model + tokenizer loading with device-appropriate dtype selection.
# ABOUTME: Imported by train_constraint, finetune_policy, evaluate_constraint and chain-of-thought scripts.
