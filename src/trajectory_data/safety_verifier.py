# ABOUTME: LLM-based safety verifier: asks Qwen (via OpenRouter) whether a trajectory broke safety rules.
# ABOUTME: Secondary label check for collected demos, complementing the benchmark's ground-truth evaluators.
"""
...
from src.trajectory_data.trajectory import Step
