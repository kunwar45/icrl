# ABOUTME: Deterministic pure-Python mock CRM environment mirroring the ST-WebAgentBench reset/step contract.
# ABOUTME: Selected with finetune.env.backend=mock for laptop smoke tests of fine-tuning and CuP evaluation.
"""
...
from src.trajectory_data.browser_actions import parse_action
...
# ── Benchmark facade (mirrors src.environments.stwebagentbench_environment.STWebAgentBench) ───────────
